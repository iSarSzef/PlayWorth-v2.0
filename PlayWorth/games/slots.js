...
function updateSaldo(newSaldo) {
    fetch('/PlayWorth/php/update_saldo.php', {
        method: 'POST',
...
async function spinanimation(){
    const startSound = new Audio('/PlayWorth/others/slot/pull.mp3');
    startSound.play();
    await sleep(500);
    const spinSound = new Audio('/PlayWorth/others/slot/spin.wav');
    spinSound.play();
    slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Bars.jpg')";
    await sleep(80);
    slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Bell.jpg')";
    await sleep(70);
    slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Cherry.jpg')";
    slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Bars.jpg')";
    await sleep(60);
    slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Diamond.jpg')";
    slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Bell.jpg')";
    for(let i = 0; i < 8; i++){
        await sleep(50);
        slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Heart.jpg')";
        slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Cherry.jpg')";
        slot3.style.backgroundImage = "url('/PlayWorth/others/slot/Bars.jpg')";
        await sleep(50);
        slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Melon.jpg')";
        slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Diamond.jpg')";
        slot3.style.backgroundImage = "url('/PlayWorth/others/slot/Bell.jpg')";
        await sleep(50);
        slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Seven.jpg')";
        slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Heart.jpg')";
        slot3.style.backgroundImage = "url('/PlayWorth/others/slot/Cherry.jpg')";
        await sleep(50);
        slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Bars.jpg')";
        slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Melon.jpg')";
        slot3.style.backgroundImage = "url('/PlayWorth/others/slot/Diamond.jpg')";
        await sleep(50);
        slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Bell.jpg')";
        slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Seven.jpg')";
        slot3.style.backgroundImage = "url('/PlayWorth/others/slot/Heart.jpg')";
        await sleep(50);
        slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Cherry.jpg')";
        slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Bars.jpg')";
        slot3.style.backgroundImage = "url('/PlayWorth/others/slot/Melon.jpg')";
        await sleep(50);
        slot1.style.backgroundImage = "url('/PlayWorth/others/slot/Diamond.jpg')";
        slot2.style.backgroundImage = "url('/PlayWorth/others/slot/Bell.jpg')";
        slot3.style.backgroundImage = "url('/PlayWorth/others/slot/Seven.jpg')";
    }
...
function showvalue(x){
    if(x==1)
        return "url('/PlayWorth/others/slot/Bars.jpg')";  
    else if(x==2)
        return "url('/PlayWorth/others/slot/Bell.jpg')";
    else if(x==3)
        return "url('/PlayWorth/others/slot/Melon.jpg')";
    else if(x==4)
        return "url('/PlayWorth/others/slot/Diamond.jpg')";
    else if(x==5)
        return "url('/PlayWorth/others/slot/Heart.jpg')";
    else if(x==6)
        return "url('/PlayWorth/others/slot/Cherry.jpg')";
    else if(x==7)
        return "url('/PlayWorth/others/slot/Seven.jpg')";
}

function result(x,y,z){
    result_sound = new Audio('/PlayWorth/others/slot/coin.mp3');
    // Jackpot: Three Sevens
    if (x == y && y == z && z == 7) {
        result_sound = new Audio('/PlayWorth/others/slot/jackpot.wav');
    ...
    // Lose
        ...
        result_sound = new Audio('/PlayWorth/others/slot/lose.mp3');
